 ...
 * {@link org.apache.commons.dbcp3.PoolingDriver} or {@link org.apache.commons.dbcp3.PoolingDataSource}. When using one
 ...
 * </p>
 * <p>
 * Q: But {@link org.apache.commons.dbcp3.PoolingDriver PoolingDriver} and
 * {@link org.apache.commons.dbcp3.PoolingDataSource PoolingDataSource} both expect an
 ...
 * {@link org.apache.commons.dbcp3.PoolableConnectionFactory}. It implements the factory and lifecycle methods of
 * {@link org.apache.commons.pool2.PooledObjectFactory} for {@link java.sql.Connection}s. But it doesn't create the
 * actual database {@link java.sql.Connection}s itself, it uses a {@link org.apache.commons.dbcp3.ConnectionFactory} for
 * that. The {@link org.apache.commons.dbcp3.PoolableConnectionFactory} will take {@link java.sql.Connection}s created
 * by the {@link org.apache.commons.dbcp3.ConnectionFactory} and wrap them with classes that implement the pooling
 * behavior.
 * </p>
 * <p>
 * Several implementations of {@link org.apache.commons.dbcp3.ConnectionFactory} are provided--one that uses
 * {@link java.sql.DriverManager} to create connections
 * ({@link org.apache.commons.dbcp3.DriverManagerConnectionFactory}), one that uses a {@link java.sql.Driver} to create
 * connections ({@link org.apache.commons.dbcp3.DriverConnectionFactory}), one that uses a {@link javax.sql.DataSource}
 * to create connections ({@link org.apache.commons.dbcp3.DataSourceConnectionFactory}).
 * </p>
 * <p>
 ...
 * {@link java.sql.DriverManager}. You'll want to create a {@link org.apache.commons.dbcp3.PoolingDataSource}.
 * </p>
 * <p>
 * The {@link org.apache.commons.dbcp3.PoolingDataSource} uses an underlying {@link org.apache.commons.pool2.ObjectPool}
 ...
 * what {@link org.apache.commons.dbcp3.PoolableConnectionFactory} is for.
 * </p>
 * <p>
 * To create the {@link org.apache.commons.dbcp3.PoolableConnectionFactory}, you'll need at least two things:
 * </p>
 * <ol>
 * <li>A {@link org.apache.commons.dbcp3.ConnectionFactory} from which the actual database {@link java.sql.Connection}s
 * will be obtained.</li>
 ...
 * {@link org.apache.commons.dbcp3.PoolableConnectionFactory}, it will automatically register itself as the
 ...
 * </pre>
 * <p>
 * To create a {@link org.apache.commons.dbcp3.PoolingDriver}, we do the same thing, except that instead of creating a
 * {@link javax.sql.DataSource} on the last line, we create a {@link org.apache.commons.dbcp3.PoolingDriver}, and
 ...
 * </pre>
 * <p>
 * Since the {@link org.apache.commons.dbcp3.PoolingDriver} registers itself with the {@link java.sql.DriverManager}
 ...
 * </pre>
 */
package org.apache.commons.dbcp3;
